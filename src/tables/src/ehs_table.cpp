...
EHSTable::EHSTable() : tableFlop{}, tableTurn{} {
  // In essence, go through the 2+3 HandIndexer set and combine with opponent,
  // turn, river 1286792 * 1081*990 = 1 377 111 930 480 combinations
...
void EHSTable::Generate5CardsTable() {
  cout << "Calculating effective hand strength table for 2 + 3 (1286792)"
       << endl;
